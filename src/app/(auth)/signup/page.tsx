  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl border border-white/40 dark:border-slate-700/50 bg-white/40 dark:bg-[#0D2440]/60 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] relative z-10">
        ...
        {successMessage ? (
          <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 p-4 rounded-lg mb-6 text-center">
